package colorempire.characters;

import basemod.abstracts.CustomPlayer;
import colorempire.cards.black.Strike_BLACK;
...
// 继承CustomPlayer类
public class black extends CustomPlayer {
    // 火堆的人物立绘（行动前）
    ...
    public black(String name) {
        super(name, PlayerColorEnum.BLACK, ORB_TEXTURES,"ExampleModResources/img/UI/orb/vfx.png", LAYER_SPEED, null, null);
    ...
    public static class PlayerColorEnum {
        ...
        @SpireEnum
        public static PlayerClass BLACK;
